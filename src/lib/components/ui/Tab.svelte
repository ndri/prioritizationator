<script lang="ts">
	...
	const { label, active, tag, onclick }: Props = $props();
</script>
...
<button
	...
	class={[
		...
		'aria-[selected=true]:bg-slate-200 aria-[selected=true]:text-slate-700',
		'aria-[selected=true]:dark:bg-slate-800 aria-[selected=true]:dark:text-slate-200'
	]}
