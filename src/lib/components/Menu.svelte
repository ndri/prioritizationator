<script lang="ts">
	...
	const itemClasses =
		'group/menuitem dark:hover:text-slate flex gap-2.5 whitespace-nowrap rounded-md px-3 py-2.5 text-left text-sm text-slate-700 hover:bg-slate-100 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-indigo-600 dark:text-slate-300 dark:hover:bg-slate-900';
	const iconClasses =
